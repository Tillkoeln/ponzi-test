...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About COIN", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>COIN</b> version", 0));
...
"Copyright \302\251 2014 The COIN developers", 0));
